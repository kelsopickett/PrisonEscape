...
public class PrisonEscape {
	...
	// declare/initialise rooms-- parameters: description,choiceA, choiceB, choiceC, choiceD, resultA, resultB, resultC, resultD
	...
	NonPlayerChar prisoner1 = new NonPlayerChar();
	NonPlayerChar doctor = new NonPlayerChar();
	NonPlayerChar gaurd = new NonPlayerChar();
	...
	protected void sceneTwo() {
		...
		btnOptionB.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				textArea.setText(gitmo[currentScene].resultB + "\n\n" + gitmo[(currentScene + 1)].description);
				// if the player is still alive keep playing this game, otherwise this game ends
				if (player.isAlive() == true && !prisoner1.isAlive()){
